...
The only reason I think you'd want to use class components really is if you want to have more granular control over the lifecycle methods.
...
Custom hooks are a way of extracting stateful logic out of react components. This enforces the DRY principle as we can use the custom hook as many times as we want without having to rewrite any of the logic again.

- [x] Why is it important to test our apps?

- Let's us discover bugs faster
